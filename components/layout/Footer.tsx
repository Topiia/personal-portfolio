            ...
            <div className="editorial-container">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 py-[clamp(2rem,4dvh,3rem)] border-b border-[rgba(243,240,232,0.10)]">
                    ...
                    <div>
                        ...
                        <p className="text-[0.75rem] text-[rgba(243,240,232,0.42)] mt-1">
                    ...
                    <a
                        href="/ai-chat"
                        className="hidden md:inline-flex items-center gap-2 text-[0.6875rem] font-semibold tracking-[0.12em] uppercase text-[rgba(243,240,232,0.40)] hover:text-acid transition-colors duration-200"
                    >
                        Ask about the work ↗
                    </a>
                    ...
                    <div className="flex items-center gap-6">
                        <a
                            ...
                            className="text-[rgba(243,240,232,0.42)] hover:text-paper transition-colors duration-200"
                            aria-label="GitHub"
                        >
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 py-[clamp(1rem,3dvh,1.5rem)]">
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-[0.6875rem] font-semibold tracking-[0.10em] uppercase text-[rgba(243,240,232,0.32)] hover:text-paper transition-colors duration-200"
                    >
                        Resume ↗
                    </a>
                </div>
