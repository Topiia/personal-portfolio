    ...
    return (
        <section id="research" className="bg-ink section-pad-lg" aria-label="MW/DW research pipeline">
            <div className="editorial-container">
                ...
                >
                    <span className="text-micro text-[rgba(200,255,56,0.60)] block mb-4">
                        07 / RESEARCH INFRASTRUCTURE
                    </span>
                    <h2
                        className="text-paper font-bold tracking-[-0.04em] leading-[0.93] mb-6"
                    ...
                    <div className="space-y-0">
                        {PHASES.map((phase, idx) => (
                            <motion.div
                                ...
                                className="grid grid-cols-1 md:grid-cols-[80px_1fr] gap-6 md:gap-12 py-8 md:py-10 border-b border-[rgba(243,240,232,0.07)]"
                            >
                                {/* Phase number */}
                                <div className="flex items-start gap-4 md:flex-col md:gap-0">
                                    <span className="text-acid font-bold tracking-[0.04em]" style={{ fontSize: '1.5rem' }}>
                                        {phase.number}
                                    </span>
                                </div>

                                {/* Content */}
                                <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-4 lg:gap-16 items-start">
                                    <div>
                                        <h3
                                            className="text-paper font-semibold tracking-[-0.025em] mb-3"
                ...
                {/* Context note */}
                <motion.div
                    className="mt-14 md:mt-16 pt-7 border-t border-[rgba(243,240,232,0.08)]"
                    variants={fadeUp(0.1)}
                    initial="hidden"
                    whileInView="visible"
                    viewport={{ once: true, margin: '-40px' }}
